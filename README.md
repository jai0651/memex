...
- **Smart History**: Type a prefix and press **Right Arrow** to see matching commands.
...
- **Shell Integration**: Seamlessly integrates with Zsh and Bash.
